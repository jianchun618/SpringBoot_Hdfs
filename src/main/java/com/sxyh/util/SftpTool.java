...
public class SftpTool {
    ...
    public static void main(String[] args) throws Exception {
        //密码认证方式
        SftpTool sftpTool = new SftpTool("192.168.134.8", "sftp_jc", 22);

        /*//上传文件
        sftpTool.upload("/verifyfile/", "C:\\Users\\jc336\\Desktop\\testfile.xls", sftpTool.new AuthTypeMode(AuthTypeEnum.PASSWORD.getCode(), "jc123456"));
*/
        //下载文件
        File saveFile = new File("/data/testfile.xls");
        sftpTool.download("/verifyfile/", "testfile.xls", saveFile, sftpTool.new AuthTypeMode(AuthTypeEnum.PASSWORD.getCode(), "jc123456"));
